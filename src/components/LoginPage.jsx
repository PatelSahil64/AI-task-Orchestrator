    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-foreground leading-tight mb-4" style={{ fontFamily: 'Manrope, sans-serif' }}>
            Let AI organize<br />
          ...
          <p className="text-muted-foreground text-base leading-relaxed mb-8">
            Dump your raw thoughts. Gemini AI will instantly assign categories, priorities, and realistic deadlines — so you can focus on what matters.
          </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            {features.map(({ icon: Icon, label, desc, color, bg }) => (
              <motion.div
                ...
                className="bg-card border border-border rounded-xl p-4 hover:border-indigo-200 dark:hover:border-indigo-800 transition-colors"
              >
        ...
        >
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-2xl shadow-black/5">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-foreground mb-2" style={{ fontFamily: 'Manrope, sans-serif' }}>
                Get started
              </h2>
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl border border-border bg-background hover:bg-accent disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-200 active:scale-[0.98] font-semibold text-sm text-foreground shadow-sm"
            >
              {loading ? (
            ...
            <div className="mt-6 pt-6 border-t border-border">
              <p className="text-xs text-muted-foreground text-center leading-relaxed">
                By signing in, your tasks are securely stored in Firebase and synced to your Google account.
              </p>
            </div>
          </div>
